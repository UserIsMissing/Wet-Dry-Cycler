...
#define SYRINGE_DIAMETER_IN   0.35    // Syringe barrel inner diameter in inches
...
/**
 ...
 void Rehydration_Push(uint32_t uL) {
     ...
     DRV8825_Move(&rehydrationMotor, steps, DRV8825_FORWARD, DRV8825_DEFAULT_STEP_DELAY_US);
 }
